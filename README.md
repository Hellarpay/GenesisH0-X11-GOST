# GenesisH0-X11-GOST
A python script for creating the parameters required for a unique genesis block. SHA256/scrypt/X11/X11-GOST/X13/X15.

### Dependencies
    sudo pip install scrypt construct==2.5.2


To create geneses based on X11 algorithm you will also need to install the [xcoin-hash](https://github.com/lhartikk/xcoin-hash) module. /n
To create geneses based on X11-GOST algorithm you will also need to install the [xcoin-hash](https://github.com/Hellarpay/x11_gost_hash) module. /n
...
Create the original genesis hash found in SibCoin. (requires [xcoin-hash](https://github.com/Hellarpay/x11_gost_hash))

    python genesis.py -a X11-GOST -z "Wired 09/Jan/2014 The Grand Experiment Goes Live:" -t 1317972665 -p "040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9" -n 28917698 -t 1390095618 -v 5000000000
...
### Options
    ...
    Options:
      ...
      -a ALGORITHM, --algorithm=ALGORITHM
         the PoW algorithm: [SHA256|scrypt|X11|X11-GOST|X13|X15]
